...
GNMI_NS='github.com/openconfig/grpctunnel'
...
bazel build //proto/tunnel:all
copy_go_generated "proto/tunnel"
bazel build //cmd/target/proto/config:all
copy_go_generated "cmd/target/proto/config"